...
public class DefaultJSONParser extends AbstractJSONParser implements Closeable {
    ...
    private Map<String, ParseContext> contextMap = new HashMap<String, ParseContext>();
    ...
    public void popContext() {
        ...
        ParseContext parseContext =  contextArray[contextArrayIndex - 1];
        contextArray[contextArrayIndex - 1] = null;
        contextArrayIndex--;
        if(parseContext!=null && parseContext.getPath()!=null && !"".equals(parseContext.getPath())){
        	contextMap.remove(parseContext.getPath());
        }
    }
    ...
    private void addContext(ParseContext context) {
        ...
        if(context!=null && context.getPath()!=null && !"".equals(context.getPath())){
